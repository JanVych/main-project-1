...
void SetTuvState(int32_t value)
{
    _tuvState = value;
}
...
void Main()
{
    ...
    while (true)
    {
        ...
        wattrouter_SetTuvState(_tuvState);
        vTaskDelay(1000 / portTICK_PERIOD_MS);
